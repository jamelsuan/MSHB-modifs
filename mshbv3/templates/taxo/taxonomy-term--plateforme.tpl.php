...
<div id="taxonomy-term-<?php print $term->tid; ?>" class="<?php print $classes; ?> bloc-interne">
  ...
  <div class="content">
    ...
    <?php
      if (isset( $term->field_bloc_liens) && ! empty( $term->field_bloc_liens)){
        print $term->field_bloc_liens['und'][0]['safe_value'];
      }
...
<?php
  ...
  else $retour = 'menu_plateforme';

?>
<br />
<div class="projet-retour"><a href="<?php print $retour; ?>">Retour aux plateformes</a></div>
